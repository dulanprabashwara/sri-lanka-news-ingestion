...
with HttpFetcher(settings) as fetcher, BackendIngestionClient(settings) as backend_client:
    ...
    for slug in source_slugs:
        ...
        try:
            ...
            logger.info(f"Result for {slug}: discovered={summary.discovered}, processed={summary.processed}, duplicates={summary.duplicates}, created={summary.created}, failed={summary.failed}")
